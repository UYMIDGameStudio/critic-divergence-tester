...
def main():
    ...
    with project_mutation_lock(output), tempfile.TemporaryDirectory(prefix="studio-build-", dir=output) as temp:
        ...
        for name in ("document-review-studio.md", "release-engineering-0.2.1.md", "release-engineering-0.2.2.md", "release-engineering-0.2.3.md", "release-engineering-0.2.4.md", "release-engineering-0.2.5.md", "release-engineering-0.2.6.md", "release-engineering-0.2.7.md", "release-engineering-0.2.8.md", "release-engineering-0.2.9.md"):
