...
**0.2.11** 修复 CRLF 换行造成的原文字符定位偏移，以及 Markdown 表格分隔线
之后的单元格行号偏差。见 [0.2.11 修复记录](docs/release-engineering-0.2.11.md)，
...
此前修复记录：[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
