...
**0.2.12** 修复 Markdown 表格的转义竖线、空单元格和横线数据丢失，并保留代码
围栏内容，避免示例标题混入正文结构。见 [0.2.12 修复记录](docs/release-engineering-0.2.12.md)，
...
此前修复记录：[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
