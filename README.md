...
**0.2.15** 让规范化 Word 副本从已校验的文档结构生成真正的表格、换行和制表符，
避免把 Markdown 标记直接写入 Word。见 [0.2.15 修复记录](docs/release-engineering-0.2.15.md)，
...
此前修复记录：[多行单元格导出](docs/release-engineering-0.2.14.md)、[文本容量保护](docs/release-engineering-0.2.13.md)、[Markdown 内容保留](docs/release-engineering-0.2.12.md)、[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
