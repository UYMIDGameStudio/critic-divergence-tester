...
**0.2.18** 在识别预览、原文侧栏和定位选项中显示已保留的列表编号与续文提示，
支持按编号搜索，并补全 HTML 识别提示的繁體中文／English 显示。见 [0.2.18 修复记录](docs/release-engineering-0.2.18.md)，
...
此前修复记录：[HTML 列表语义](docs/release-engineering-0.2.17.md)、[原稿编号保留](docs/release-engineering-0.2.16.md)、[Word 结构导出](docs/release-engineering-0.2.15.md)、[多行单元格导出](docs/release-engineering-0.2.14.md)、[文本容量保护](docs/release-engineering-0.2.13.md)、[Markdown 内容保留](docs/release-engineering-0.2.12.md)、[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
