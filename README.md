...
**0.2.16** 保留文本原稿中的列表编号与项目符号，避免将跳号、重新起号及前提编号
统一改成「1」。审查输入、Markdown 和规范化 Word 共用原始标记。见 [0.2.16 修复记录](docs/release-engineering-0.2.16.md)，
...
此前修复记录：[Word 结构导出](docs/release-engineering-0.2.15.md)、[多行单元格导出](docs/release-engineering-0.2.14.md)、[文本容量保护](docs/release-engineering-0.2.13.md)、[Markdown 内容保留](docs/release-engineering-0.2.12.md)、[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
