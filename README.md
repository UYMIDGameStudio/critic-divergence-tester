...
**0.2.13** 为纯文本和 Markdown 补齐结构容量限制，减少长表格单元格的临时内存
占用；超限稿件保留原件并明确报错。见 [0.2.13 修复记录](docs/release-engineering-0.2.13.md)，
...
此前修复记录：[Markdown 内容保留](docs/release-engineering-0.2.12.md)、[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
