...
**0.2.17** 保留 HTML 列表的起号、跳号、倒序及常见字母／罗马数字标记，在审查数据中
记录嵌套条目与续文的归属，并修复隐藏条目省略闭合时吞掉后文的问题。见 [0.2.17 修复记录](docs/release-engineering-0.2.17.md)，
...
此前修复记录：[原稿编号保留](docs/release-engineering-0.2.16.md)、[Word 结构导出](docs/release-engineering-0.2.15.md)、[多行单元格导出](docs/release-engineering-0.2.14.md)、[文本容量保护](docs/release-engineering-0.2.13.md)、[Markdown 内容保留](docs/release-engineering-0.2.12.md)、[原文定位](docs/release-engineering-0.2.11.md)、[文件名保护](docs/release-engineering-0.2.10.md)、[表格导入容量保护](docs/release-engineering-0.2.9.md)、[浏览器启动与双语维护提示](docs/release-engineering-0.2.8.md)、[删除中断与备份恢复](docs/release-engineering-0.2.7.md)、
